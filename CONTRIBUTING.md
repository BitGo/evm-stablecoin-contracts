...
This project is maintained by the [BitGo Stablecoins team](https://github.com/orgs/BitGo/teams/stablecoins). The maintainers are responsible for reviewing and merging contributions, managing releases, and setting the project roadmap.
