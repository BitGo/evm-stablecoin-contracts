...
contract Blacklistable is AccessControlUpgradeable, InternalERC20Upgradeable {
    ...
    // fetches balance of an account from the last 255 bits of accountBalancesAndFlags
    function balanceOf(
        address account
    ...
    function _update(
        ...
        // Check if the recipient is blacklisted, unless it's a burning operation (to == address(0))
        require(
            to == address(0) || !isBlacklisted(to),
            "ERC20: recipient is blacklisted"
        );
